        ...
        <div className="container py-12 max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-12">
              ...
              >
                <div className="w-full aspect-square bg-surface rounded-xl flex items-center justify-center overflow-hidden group">
                  <img
              ...
              <div className="rounded-xl border border-border bg-card shadow-card overflow-hidden">
                {specs.map((spec, i) => (
                  <motion.div
                    ...
                    className={`flex items-center justify-between px-5 py-3 ${i % 2 === 0 ? "" : "bg-surface/50"}`}
                  >
